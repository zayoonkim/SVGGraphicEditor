...
export default class UIView {
  ...
  createToolbar() {
    ...
    this.addTools.appendChild(this.addRectangleButton);
    this.addTools.appendChild(this.addEllipseButton);
    this.addTools.appendChild(this.addTriangleButton);
  ...
  addShape(shapeType) {
    this.canvasView.addShape(shapeType);
  }
}
